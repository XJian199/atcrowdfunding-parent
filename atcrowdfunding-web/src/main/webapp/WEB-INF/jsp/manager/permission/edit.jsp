    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <ol class="breadcrumb">
                ...
                <li><a href="${APP_PATH}/manager/permission/index.htm">数据列表</a></li>
                ...
                <div class="panel-body">
                    <form role="form">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="permissionName" value="${permission.name}" placeholder="请输入许可名称">
                        </div>
                        <div class="form-group">
        ...
        $.ajax({
            ...
            success : function(result) {
                ...
                if ( result.success ) {
                    ...
                    layer.msg("许可信息修改失败", {time:1000, icon:5, shift:6});
                }
            }
        });
    });
