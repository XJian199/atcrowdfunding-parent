            ...
            success : function( result ) {
                ...
                if ( result.success ) {
                    ...
                    $.each(certList, function(i, cert){
                        ...
                        content = content +  '	   <button type="button" onclick="deleteUser('+cert.id+', \''+cert.name+'\')" class="btn btn-danger btn-xs"><i class=" glyphicon glyphicon-remove"></i></button>';
                        content = content +  '  </td>';
                        content = content +  '</tr>';
                    });
