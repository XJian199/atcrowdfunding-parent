                ...
                <div class="panel-body">
                    <form id="userForm" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="email" value="${user.email}" placeholder="请输入邮箱地址">
    ...
    $("#updateBtn").click(function(){
        ...
        $.ajax({
            ...
            success : function(result) {
                ...
                if (result.success) {
                    layer.msg("用户信息修改成功", {time:1500, icon:6}, function(){
                        window.location.href = "${APP_PATH}/user/index.htm?pageno=${param.pageno}";
                    });
                } else {
                    layer.msg("用户信息修改失败", {time:1500, icon:5, shift:6});
                }
            }
        });
    });
