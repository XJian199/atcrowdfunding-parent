...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active" onclick="window.location.href='${APP_PATH}/project.htm'" style="cursor:pointer;">
            <img src="img/carousel-1.jpg" alt="First slide">
        </div>
        <div class="item" onclick="window.location.href='${APP_PATH}/project.htm'" style="cursor:pointer;">
...
<div class="container marketing">
    ...
    <div class="row">
        <div class="col-lg-4">
            ...
            <p><a class="btn btn-default" href="${APP_PATH}/project.htm" role="button">项目详情 &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    ...
                                    <div class="caption">
                                        <h3 class="break">
                                            <a href="${APP_PATH}/project.htm">活性富氢净水直饮机</a>
                                        </h3>
                                        <p>
                            ...
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    ...
                                    <div class="caption">
                                        <h3 class="break">
                                            <a href="${APP_PATH}/project.htm">酷驰触控龙头，智享厨房黑科技</a>
                                        </h3>
                                        <p>
                                        <div style="float:left;"><i class="glyphicon glyphicon-screenshot"
                                                                    title="目标金额"></i> $20,000
                            ...
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    ...
                                    <div class="caption">
                                        <h3 class="break">
                                            <a href="${APP_PATH}/project.htm">小熊猫鱼眼全景安防摄像机</a>
                                        </h3>
                                        <p>
                                        <div style="float:left;"><i class="glyphicon glyphicon-screenshot"
                                                                    title="目标金额"></i> $20,000
                            ...
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    ...
                                    <div class="caption">
                                        <h3 class="break">
                                            <a href="${APP_PATH}/project.htm">一款精致的机械表</a>
                                        </h3>
                                        <p>
                                        <div style="float:left;"><i class="glyphicon glyphicon-screenshot"
                                                                    title="目标金额"></i> $20,000
...
<script>
    ...
    $(".thumbnail img").click(function () {
        window.location.href = "${APP_PATH}/project.htm";
    });
    $.each($("img"), function () {
        // 循环体
        // this ==> $(DOM对象) ==> JQuery对象.方法
